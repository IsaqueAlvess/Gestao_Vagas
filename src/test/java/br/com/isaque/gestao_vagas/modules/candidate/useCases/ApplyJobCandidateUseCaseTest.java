package br.com.isaque.gestao_vagas.modules.candidate.useCases;
...
public class ApplyJobCandidateUseCaseTest {
    ...
    @InjectMocks //Injeção da classe que eu quero testar
    private ApplyJobCandidateUseCase applyJobCandidateUseCase;

    @Mock       //Dependência da classe principal sendo testada.
    ...
    public void should_be_able_to_create_a_new_apply_job(){
        ...
        assertThat(result).hasFieldOrProperty("id"); //verificando se possui a propriedade
